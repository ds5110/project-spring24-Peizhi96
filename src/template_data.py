...
class ReportData:
    def __init__(self):
        ...
        self.domestic_average_market_value: YearValue = None
        self.domestic_median_market_value: YearValue = None

        self.domestic_maximum_market_volume: YearValue = None
        self.domestic_average_market_volume: YearValue = None
        self.domestic_median_market_volume: YearValue = None

        self.na_maximum_market_value: YearValue = None
        self.na_average_market_value: YearValue = None
        self.na_median_market_value: YearValue = None

        self.na_maximum_market_volume: YearValue = None
        self.na_average_market_volume: YearValue = None
        self.na_median_market_volume: YearValue = None

        self.domestic_maximum_market_value_per_pound: YearValue = None
        self.domestic_stats_market_value_per_pound: list[StatsPair] = None

        self.na_maximum_market_value_per_pound: YearValue = None
        self.na_stats_market_value_per_pound: list[StatsPair] = None
